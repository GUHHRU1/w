        ...
        case 'join':
            ...
            if (isOwnerBot) {
                ...
                await aruga.joinGroupViaLink(linkgrup)
                      ...
                      .catch(() => {
                          aruga.reply(from, 'Fracassado!', id)
                      })
        ...
        function isStickerMsg(id){
            ...
            for (let i of stickerspam){
                if(i.id === id){
                    if (i.msg >= 7) {
                        found === true 
                        aruga.reply(from, '*[ANTI STICKER SPAM]*\nVocê tem SPAM STICKER no grupo, você será chutado automaticamente pelo bot', message.id).then(() => {
                            ...
                            if (found !== false) {
                                ...
                                const result = '✅ DB Sticker Spam foi redefinido'
